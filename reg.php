...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col">
				<a href="index.php" style="margin-bottom: 100px;"><img src="left_arrow.png" style="max-width: 50px; "></a>
				<br>
				<br>
				<br>
				<br>
...
if (isset($_POST['submit'])) {
	...
	if(mysqli_num_rows($duplicate) > 0){
		...
		if($pw == $cpw){
			$query = ("INSERT INTO user VALUES ('','$fname','$lname','$add','$phone','$bday','$uname','$email','$pw','U')");
